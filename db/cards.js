var cardsData = [
    {
        _id: {
            $oid: "6776e41067410d548d4eeba0",
        },
        question: "Who were the first designers of the computer in the 1940s?",
        answer: "Alan Turing and John von Neumann.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba1",
        },
        question: "What is a computer?",
        answer: "A machine that can store both instructions (programs) and data in its memory and execute those instructions.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba2",
        },
        question: "What are the five main operations of a computer?",
        answer: "Take Input, Store Data, Process Data, Output Information, Control the workflow.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba3",
        },
        question: "What is the system unit?",
        answer: "The case that contains the electronic components of a computer used to process data.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba4",
        },
        question: "Name three common components inside the system unit.",
        answer: "Processor, Memory, Adapter Cards.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba5",
        },
        question: "What is a motherboard?",
        answer: "The main circuit board in the system unit, housing the adapter cards, processor chips, and memory chips.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba6",
        },
        question: "What is a chip in computing?",
        answer: "A small piece of semi-conducting material on which integrated circuits are engraved.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba7",
        },
        question: "What are the two main parts of the CPU?",
        answer: "Control Unit and Arithmetic Logic Unit (ALU).",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba8",
        },
        question: "What does the Control Unit do?",
        answer: "It directs and coordinates operations in the computer.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eeba9",
        },
        question: "What is the function of the Arithmetic Logic Unit (ALU)?",
        answer: "It performs arithmetic, comparison, and logical operations.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebaa",
        },
        question: "What are the four steps in the CPU's machine cycle?",
        answer: "Fetch, Decode, Execute, Store.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebab",
        },
        question: "What is pipelining in the context of a CPU?",
        answer: "Fetching the second instruction before completing the first, resulting in faster processing.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebac",
        },
        question: "What is a register in a CPU?",
        answer: "A temporary high-speed storage area that holds data and instructions.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebad",
        },
        question: "What is the system clock?",
        answer: "It regulates timing and speed of all computer operations.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebae",
        },
        question: "What are the three types of buses in a computer?",
        answer: "Address Bus, Data Bus, Control Bus.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebaf",
        },
        question: "What is memory in a computer?",
        answer: "Semi-conductors used for data storage, each byte stored in a unique location called an address.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb0",
        },
        question: "What is RAM?",
        answer: "Random Access Memory, a type of memory that can be read from and written to by the processor.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb1",
        },
        question: "Name three types of RAM.",
        answer: "Static RAM (SRAM), Dynamic RAM (DRAM), Synchronous Dynamic RAM (SDRAM).",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb2",
        },
        question: "What is the difference between SRAM and DRAM?",
        answer: "SRAM doesn’t require refreshing, while DRAM requires continuous refreshing.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb3",
        },
        question: "What is ROM?",
        answer: "Read-Only Memory, a non-volatile memory that stores permanent data and instructions.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb4",
        },
        question: "What is cache memory?",
        answer: "A fast memory that acts as a buffer between the processor and main memory.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb5",
        },
        question: "What is an expansion card?",
        answer: "A circuit board that plugs into the motherboard to expand its capabilities.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb6",
        },
        question: "Name three types of expansion slots.",
        answer: "ISA, PCI, AGP.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb7",
        },
        question: "What are ports?",
        answer: "Connectors that join cables to peripherals, allowing external devices to connect to the system unit.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6776e41067410d548d4eebb8",
        },
        question: "What is booting a computer?",
        answer: "The sequence of operations from power-up until the system is ready for use.",
        topicName: "Computer Hardware",
    },
    {
        _id: {
            $oid: "6778b2d3978dec22464eeb88",
        },
